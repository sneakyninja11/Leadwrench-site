export default function LeadwrenchWebsite() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <section id="results" className="border-y border-white/10 bg-white/5">
        <div className="mx-auto max-w-7xl px-6 py-20">
          <div className="mb-12 max-w-2xl">
            <p className="text-sm font-semibold uppercase tracking-[0.2em] text-cyan-300">Proof</p>
            <h2 className="mt-3 text-3xl font-black md:text-4xl">
              Trusted by HVAC contractors across the Oklahoma City metro area
            </h2>
            <p className="mt-4 text-slate-300">
              We’re building out our first case studies and testimonials. For now, Leadwrench is focused on simple, fast systems for local HVAC businesses.
            </p>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            <div className="rounded-[1.75rem] border border-white/10 bg-slate-900/60 p-6">
              <h3 className="text-xl font-bold">Built for Trades</h3>
              <p className="mt-3 text-sm leading-7 text-slate-300">
          ...
          <div>
            ...
            <div className="mt-8 space-y-3 text-slate-300">
              ...
              <p>
                ...
                <a href="mailto:77195pittman@gmail.com" className="text-cyan-300 hover:text-cyan-200">
            ...
            >
              ...
              <div>
                ...
                <input
                  name="contact"
                  className="w-full rounded-xl border border-white/10 bg-slate-950 px-4 py-3 text-white outline-none ring-0 placeholder:text-slate-500"
                  placeholder="you@example.com or (405) 662-4753"
                  required
                />
              </div>
              <div>
              ...
              <button type="submit" className="w-full rounded-2xl bg-cyan-400 px-6 py-3 font-semibold text-slate-950 transition hover:scale-[1.01]">
                Request Demo
              </button>
